CC=gcc
shell: main.o signal-handling.o read.o execute.o builtin.o syscomm.o  parse.o header.h
	$(CC)  -o shell main.o signal-handling.o read.o execute.o builtin.o syscomm.o parse.o -I.
